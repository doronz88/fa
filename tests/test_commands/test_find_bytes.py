...
@pytest.mark.parametrize("segments,instruction,result", [
    # Sanity
    ([(0x12345678, b"\x11\x22\x33\x44")], "find-bytes --or '11223344'",
     [0x12345678]),
    ([(0x12345678, b"\x00\x00\x00\x00")], "find-bytes --or '00000000'",
     [0x12345678]),
    ([(0x12345678, b"\xff\xff\xff\xff")], "find-bytes --or 'ffffffff'",
     [0x12345678]),
    # No results
    ([(0x12345678, b"\x11\x22\x33\x45")], "find-bytes --or '11223344'", []),
    ([(0x12345678, b"\x00\x00\x00\x00")], "find-bytes --or '11223344'", []),
    ([(0x12345678, b"\xff\xff\xff\xff")], "find-bytes --or '11223344'", []),
    ([(0x12345678, b"\x44\x33\x22\x11")], "find-bytes --or '11223344'", []),
    ...
    ([(0x12345678, b"\x11\x22\x11\x22\x11\x22")], "find-bytes --or '11221122'",
...
@pytest.mark.parametrize("segments,instructions,result", [
    ...
    ([(0x12345678, b"\x11\x22\x33\x44\x11\x22\x11\x22")],
     ["find-bytes --or '11223344'", "find-bytes --or '11221122'", "sort"],
    ...
    ([(0x12345678, b"\x11\x22\x33\x44\x11\x22\x11\x23")],
     ["find-bytes --or '11223344'", "find-bytes --or '11223344'", "sort"],
     [0x12345678]),
])
